...
/**
 * Embeddable chat-audit content. Used both by the legacy /chat-audit route
 * (wrapped in Sidebar + PasswordGate + GooniLayer) and the new "Chat audit"
 * tab inside the Audit/Eval page (bare). Active feedback rules + the
 * per-reply audit feed live here; everything outside this component is
 * chrome.
 */
export function ChatAuditPanel() {
  ...
  return (
    <div style={{ fontFamily: FONT, padding: "16px 24px 32px" }}>
