...
// The creative plaza entry — the 3D jump-in scene that leads into /walk.
// Extracted from the old /creative route so it can be the front door at
// /public (the company-facing portfolio) while /creative stays a redirect
