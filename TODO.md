...
- [ ] Jarvis memory context — include top-3 relevant memories in Jarvis prompt (not just the active note)
- [ ] Telegram → note sync: messages captured via Telegram appear as notes in the relevant space
...
- [x] Space delete — hover × button with inline confirm, cascades to notes
