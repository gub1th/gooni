...
- **`components/Dashboard.tsx`** — Single-column. Mode toggle (Today|Review|Ops|Stats, key `gooni-dashboard-v3`, migrates `build`→`ops`, `pulse`→`stats`). Today body reacts to `composerFocused`.
