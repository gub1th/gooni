...
## 0.266.0 — 2026-09-09 (minor)

- feat(focus): show the screen summary + scrubber in the session recap (#557)
...
## 0.263.0 — 2026-09-09 (minor)

- feat(sensor): collect the frontmost window title, not just the app (#554)

## 0.262.0 — 2026-09-09 (minor)

- feat(sensor): surface WHAT was browsed, not just where (#553)

## 0.261.1 — 2026-09-09 (patch)

- fix(home): the note editor could not be closed until you typed in it (#552)

## 0.261.0 — 2026-09-09 (minor)

- feat(home): rest the centre as the capture box, wave behind a setting (#550)

## 0.260.0 — 2026-09-07 (minor)

- feat(focus): congratulate a finished focus task on WhatsApp, over one shared sender (#549)

## 0.259.2 — 2026-09-07 (patch)

- fix(focus): stop a stale poll from resurrecting a session you just stopped (#548)

## 0.259.1 — 2026-09-07 (patch)

- fix(desktop): spawn the sidecar attached so it can hold a camera grant (#547)

## 0.259.0 — 2026-08-22 (minor)

- feat(notes): folders — Topic becomes the notes sidebar's tree, tags go invisible (#543)

## 0.258.0 — 2026-08-22 (minor)

- feat(notes): delete drafts — a note is private or public, nothing between (#540)

## 0.257.0 — 2026-08-22 (minor)

- feat(notes): selecting text starts a focus session, shown inline (#536)

## 0.256.0 — 2026-08-22 (minor)

- feat(notes): archive — the non-destructive hide (#535)

## 0.255.3 — 2026-08-17 (patch)

- fix(ultrahuman): drop email param from API calls (#533)
...
## 0.254.0 — 2026-08-17 (minor)

- feat(focus): rebuild session recap as an analytics dashboard (#527)
...
## 0.251.1 — 2026-08-16 (patch)

- fix(notes): cleanup deletes only truly empty notes, not short real content (#524)

## 0.251.0 — 2026-08-16 (minor)

- feat(focus): session-scoped activity, one sensor read, on-task nudges (#522)

## 0.250.0 — 2026-08-16 (minor)

- feat(desktop): auto-detect focus-cam sidecar + camera picker (#521)

## 0.249.0 — 2026-08-16 (minor)

- feat(focus): camera gallery, completion selfie, richer recap, status indicator (#519)

## 0.248.0 — 2026-08-16 (minor)

- feat(initiatives): synthesize life initiatives from memories, thoughts + promises (#515)

## 0.247.2 — 2026-08-16 (patch)

- fix(shell): notes slide, home reveal, header date, honest location (#514)

## 0.247.1 — 2026-08-16 (patch)

- fix(quickfind): near-opaque dropdown ground so wave doesn't bleed through (#513)

## 0.247.0 — 2026-08-16 (minor)

- feat(focus): session detail modal with phone/browser/app breakdown, self-host filtering (#512)
...
## 0.245.4 — 2026-08-16 (patch)

- fix(frontend): wrap long proactive observations instead of truncating (#506)

## 0.245.3 — 2026-08-16 (patch)

- fix(frontend): restore force-directed memory graph in MemoryGraphModal (#505)

## 0.245.2 — 2026-08-16 (patch)

- fix(frontend): deployments health probe + audit output newlines (#504)

## 0.245.1 — 2026-08-16 (patch)

- fix(frontend): Google integration card mentions Gmail scope (#503)

## 0.245.0 — 2026-08-16 (minor)

- feat(extension): rename to Gooni Extension + mascot icons (#502)
...
## 0.243.0 — 2026-08-16 (minor)

- feat(frontend): ambient breathe on activity pill (#497)

## 0.242.0 — 2026-08-16 (minor)

- feat(frontend): grow /focus into a full hub (#496)
...
## 0.241.4 — 2026-08-16 (patch)

- fix(frontend): ten ambient-surface UI fixes (colors, chrome, styling) (#493)

## 0.241.3 — 2026-08-16 (patch)

- fix(frontend): restore icon rail on notes, always-expand notes sidebar (#492)

## 0.241.2 — 2026-08-16 (patch)

- fix(frontend): unclip focus-glow ring on TODAY row checkbox (#491)

## 0.241.1 — 2026-08-15 (patch)

- fix(frontend): trackables/notes slide-in, brain image cutoff+graph modal, focus stop completes task, focus history (#488)

## 0.241.0 — 2026-08-15 (minor)

- feat(ambient): capture dims the home instead of deleting it; note pill expands the box into the real editor (#487)

## 0.240.1 — 2026-08-15 (patch)

- fix(home): icon+pill on the activity line, hide undated, drop panel edge (#486)

## 0.240.0 — 2026-08-15 (minor)

- feat(proactive): background loop that speaks first, gated on asymmetric value (#485)

## 0.239.0 — 2026-08-15 (minor)

- feat(orchestrator): add staleness awareness to device activity context (#484)
...
## 0.236.2 — 2026-08-15 (patch)

- fix(promises): raise chat auto-close bar to 0.85, ask on near miss (#480)
...
## 0.235.1 — 2026-08-15 (patch)

- fix(desktop): make the Electron window daily-drivable (#477)
...
## 0.233.0 — 2026-08-14 (minor)

- feat(extension): the ambient home is Chrome's new tab (#473)
...
## 0.231.0 — 2026-08-12 (minor)

- feat(notch): UP NEXT all day, graded by the horizon — drop the calendar dot (#470)
...
## 0.226.2 — 2026-08-10 (patch)

- fix(deps): pin mcp[cli] to <2 — SDK 2.0 dropped mcp.server.fastmcp (#462)
...
## 0.218.0 — 2026-07-30 (minor)

- feat(portfolio): walk controls + music, resume-accurate CV, dark callouts, tile/poster polish (#449)

## 0.217.1 — 2026-07-29 (patch)

- fix(dash): cap + centre the board so a sparse day reads as calm (#447)

## 0.217.0 — 2026-07-29 (minor)

- feat(focus): ambient dash rebuild — kill the log, state machine, promise-bound focus (#446)

## 0.216.1 — 2026-07-29 (patch)

- fix(rail): round feed floats, dedup identical polls, phrase device events (#445)

## 0.216.0 — 2026-07-27 (minor)

- feat(focus): CRUD for promises + reminders on the home rail (#441)
...
## 0.213.0 — 2026-07-24 (minor)

- feat(focus): make Focus the home; rail redesign + promise said-vs-done lifecycle (#438)
...
## 0.209.0 — 2026-07-23 (minor)

- feat(focus-mcp): mount connector in-app at /mcp for Fly (always-on, no tunnel) (#432)
...
## 0.207.0 — 2026-07-20 (minor)

- feat(theme): app-wide light/dark toggle + widget resize + log order (#429)

## 0.206.0 — 2026-07-18 (minor)

- feat(log): compact daily-dots glance drops shortcuts — priority-only (#428)

## 0.205.0 — 2026-07-17 (minor)

- feat(rail): honest activity log — sync/log split, stale-day tags, per-row hover (#427)

## 0.204.0 — 2026-07-17 (minor)

- feat(integrations): 24hr Fitness → exercise via hourly server-side loop (#426)

## 0.203.0 — 2026-07-16 (minor)

- feat(home): activity log moves under the wave — dim block, hover-brighten (#424)

## 0.202.0 — 2026-07-16 (minor)

- feat(events): generic iOS Shortcuts event ingest → Trackables (#423)

## 0.201.0 — 2026-07-16 (minor)

- feat(trackables): explicit log tool replaces fitness auto-writer (#422)
...
## 0.198.0 — 2026-07-13 (minor)

- feat(audit): dark-frost migration + orb removal + memory provenance (#418)

## 0.197.0 — 2026-07-13 (minor)

- feat(ambient): glance-first turn-audit flow + eval deep-link (#417)

## 0.196.0 — 2026-07-12 (minor)

- feat(home): sticky notes get hover-X delete, drop drag-to-trash (#416)

## 0.195.0 — 2026-07-12 (minor)

- feat(ambient): recent-chat ribbon + per-turn audit trace (#415)
...
## 0.192.0 — 2026-07-11 (minor)

- feat(home): log-matrix clear + infinite scroll, daily-note column, sticky notes (#412)

## 0.191.0 — 2026-07-11 (minor)

- feat(shell): one nav, views as frosted sheets — unify old views with ambient home (#411)
...
## 0.189.0 — 2026-07-10 (minor)

- feat(home): ambient waveform home — log surface, omnibox recall, retire stats (#407)
...
## 0.187.0 — 2026-07-09 (minor)

- feat(nuke): ambient-loop v2 Slices 6+7 — primitive nuke sweep + log-first shell (#404)
...
## 0.184.0 — 2026-07-09 (minor)

- feat(log): ambient-loop v2 Slice 3 — log view + glow + 1-click promote (#401)

## 0.183.0 — 2026-07-09 (minor)

- feat(trackables): ambient-loop v2 Slice 2 — Trackable + TrackableEntry primitive (#400)

## 0.182.0 — 2026-07-09 (minor)

- feat(promises): ambient-loop v2 Slice 1 — Promise refactor + unified extract_signals emit (#399)

## 0.181.0 — 2026-06-11 (minor)

- feat(notes): table editing controls (add/delete rows & cols) (#396)
...
## 0.180.0 — 2026-05-26 (minor)

- feat(todos): phase 2 — drag files onto a todo row + paperclip count (#391)

## 0.179.1 — 2026-05-26 (patch)

- fix: restore add_note + kill fitness running-total compounding (#390)

## 0.179.0 — 2026-05-26 (minor)

- feat(todos): attach files to a todo via its edit modal (#389)
...
## 0.178.3 — 2026-05-26 (patch)

- fix(sidebar): clicking a space switches to notes view (#386)
...
## 0.176.0 — 2026-05-25 (minor)

- feat(cut): redesign cut table — compact grid, boolean substances, limit red/green (#376)

## 0.175.1 — 2026-05-25 (patch)

- fix(cut): rename _CutCell → CutCell to satisfy rules-of-hooks (#375)

## 0.175.0 — 2026-05-25 (minor)

- feat(cut): editable cut table + substance/note columns + prod backfill (#374)

## 0.174.2 — 2026-05-25 (patch)

- fix(orchestrator): forward ALL signals to dispatch (fitness was dropped) (#372)

## 0.174.1 — 2026-05-25 (patch)

- fix(promise): repair _cos import in voice-of-reason + trace observability (#371)
...
## 0.172.0 — 2026-05-24 (minor)

- feat(tv): read-only ambient dashboard tab (#342) (#367)

## 0.171.0 — 2026-05-24 (minor)

- feat(nudge): procrastination ping for stalled 'doing' todos (#341) (#366)

## 0.170.0 — 2026-05-24 (minor)

- feat(review): desktop review mode — triage the limbo queue (#340) (#365)

## 0.169.0 — 2026-05-24 (minor)

- feat(batch): session-summary notes (#339) (#364)

## 0.168.0 — 2026-05-24 (minor)

- feat(batch): 5am batch processor + LimboItem staging layer (#338) (#363)

## 0.167.0 — 2026-05-24 (minor)

- feat(persona): master prompt → 4 operating modes + ack variants (v8) (#337) (#362)
...
## 0.165.1 — 2026-05-24 (patch)

- fix(analytics): count unique human page-views, exclude owner (#348)
...
## 0.163.0 — 2026-05-24 (minor)

- feat(eval): formatted-view modal for master_prompt + big trace payloads (#338)

## 0.162.0 — 2026-05-24 (minor)

- feat(notes): @-mention to reference an existing note (#337)

## 0.161.1 — 2026-05-24 (patch)

- fix(notes): note card = full-width block panel, not per-line pills (#336)

## 0.161.0 — 2026-05-23 (minor)

- feat(tools): G5 — structured tool returns + M#N strip (#313) (#335)
...
## 0.158.0 — 2026-05-22 (minor)

- feat(agent): tool-history priors + whoop debounce + tracked-tighten + greeting fast-path + reflexion sev-1 bias (#332)

## 0.157.0 — 2026-05-22 (minor)

- feat(sidebar): v2.2 — unified 13px hierarchy, Chat→bottom nav, fix compose (#331)

## 0.156.0 — 2026-05-22 (minor)

- feat(whoop): persist sleep timing + efficiency + disturbance count (#330)
...
## 0.153.0 — 2026-05-22 (minor)

- feat(persona): identity-ask example pair + recovery-beat shape fix (#327)
