...
(The `/home` screenshot I pasted was a temp file and didn't survive — it's the ambient waveform
page with the calendar widget top-left, the trackables/silent pills, and the dimmed activity rail
underneath.)
